...
/// </summary>
internal sealed class PageMap(IReadOnlyDictionary<short, IReadOnlyList<PageRun>> runs)
{
    ...
    /// </remarks>
    public bool TryGetLocation(PageAddress pageAddress, out PageLocation location)
    {
        location = default;
        ...
        while (low <= high)
        {
            ...
            else
            {
                ...
                location = new PageLocation(run.StripeIndex, offset);
