...
internal static class PageMapper
{
    ...
    /// </summary>
    public static PageMap Build(IReadOnlyList<Stripe> stripes,
                                ...
                                IProgress<ProgressDetail>? progress = null)
    {
        ...
        foreach (var (stripe, block) in orderedDataBlocks)
        {
            foreach (var stream in block.Streams)
            {
                ...
                ScanStream(stripe, stream, builder, cancellationToken, progress);
                                   ...
                                   IProgress<ProgressDetail>? progress = null)
    {
        ...
        while (pageIndex < pageCount)
        {
            ...
            reporter.Report(pageIndex, pageCount);
