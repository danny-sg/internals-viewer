...
/// validated BackupMediaSet - holding a BackupMediaSet is proof validation has run, and the raw claims never leave this class.
/// </remarks>
internal static class BackupMediaSetReader
{
    public static BackupMediaSet Read(IReadOnlyList<BackupMediaSource> sources)
    {
        ...
        return new BackupMediaSet(configuration, orderedFamilies);
    }
