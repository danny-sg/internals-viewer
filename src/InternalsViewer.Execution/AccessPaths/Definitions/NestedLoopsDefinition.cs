...
/// <summary>
/// Describes a nested loops join, an ordered outer input driving an inner input that restarts for every outer row
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record NestedLoopsDefinition(RangeDefinition Outer, IteratorDefinition Inner) : JoinDefinition;
