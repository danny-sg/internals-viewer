...
using InternalsViewer.Execution.BatchMode.Data;
...
using InternalsViewer.Execution.BatchMode.Records;
...
public sealed class BatchHashAggregateIterator(IIteratorFactory factory) : IBatchIterator, IHashTableSource
{
    ...
    private async Task<ExecutionBatch?> EmitBatchAsync(CancellationToken cancellationToken)
    {
        ...
        if (groups.Count == 0)
        {
            ...
            StopReason = InternalsViewer.Execution.Common.AccessPaths.Results.StopReason.RowGroupsExhausted;
