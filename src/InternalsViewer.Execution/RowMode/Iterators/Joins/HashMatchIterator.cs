...
using InternalsViewer.Execution.Common.AccessPaths.Memory;
...
public sealed class HashMatchIterator(IIteratorFactory factory) : JoinIterator, IHashTableIterator, IMemoryBufferIterator
{
    ...
    protected override async IAsyncEnumerable<IRecord> RunAsync()
    {
        ...
        var reason = Inner.Iterator.StopReason ?? Outer.Iterator.StopReason ?? InternalsViewer.Execution.Common.AccessPaths.Results.StopReason.PageExhausted;
