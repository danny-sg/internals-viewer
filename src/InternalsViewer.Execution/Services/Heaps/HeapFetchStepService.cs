...
namespace InternalsViewer.Execution.Services.Heaps;
...
/// </remarks>
public sealed class HeapFetchStepService(IPageService pageService, IRecordService recordService) : IStepService
{
                           ...
                           AccessCounters counters = default)
    {
        ...
        Strategy = AccessStrategyBuilder.BuildHeapFetch(residual);

        Steps = Fetch(rowIdentifier, cancellationToken).GetEnumerator();
