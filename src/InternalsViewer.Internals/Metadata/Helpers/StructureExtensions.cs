...
{
    public static string ToDetailString(this TableStructure structure, int indent = 0)
    {
        var i = new string(' ', indent);

        var sb = new StringBuilder();
        sb.AppendLine($"{i}Table Structure");
        sb.AppendLine($"{i}---------------");
        ...
        sb.AppendLine($"{i}  Column Id | Is Key | {columnNameTitle} | Type            | Length | Precision | Scale | Leaf Offset | Node Offset | Is Dropped | Is Uniqueifier | ");
    ...
    public static string ToDetailString(this IndexStructure structure, int indent = 0)
    {
        ...
        if (structure.TableStructure != null)
        {
            ...
            sb.AppendLine();
            sb.AppendLine(structure.TableStructure.ToDetailString(4));
        }
