    ...
    where TStructure : ColumnStructure
{
    ...
    private static void ParseLongDataClusterArray(CdRecord record, byte[] data, int offset)
    {
    ...
    private static void ParseShortDataClusterArray(CdRecord record, byte[] data, int offset)
    {
    ...
    /// </remarks>
    private static short LoadColumnCount(CdRecord record, byte[] data, int offset)
    {
        short size;
