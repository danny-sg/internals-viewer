...
public static class LockModeClassifier
{
    ...
    {
        LockMode.S or LockMode.IS => LockModeCategory.Read,
        ...
        LockMode.SCH_S or LockMode.SCH_M => LockModeCategory.Schema,
    ...
    public static bool IsSuperseding(LockMode mode) =>
        mode is LockMode.X or LockMode.UIX or LockMode.U or LockMode.S or LockMode.SIX;
}
