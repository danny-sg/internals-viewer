...
public class PfsPageLoaderTests(ITestOutputHelper output)
{
    ...
    public async Task Can_Load_Page()
    {
        ...
        var pageService = new PageLoader(reader,
                                          compressionInfoService.Object);

        var database = new DatabaseDetail { Name = "TestDatabase" };

        var service = new PfsPageLoader(pageService);
    ...
    public async Task Non_Pfs_Page_Throws_Exception()
    {
        ...
        var pageService = new PageLoader(reader, compressionInfoService.Object);
