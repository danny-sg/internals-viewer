...
-- Columnstore: No Elimination
SELECT COUNT_BIG(*)
FROM   dbo.ColumnstoreTable
WHERE  Quantity = 500
GO

-- Columnstore: String Dictionary
SELECT Symbol
      ,COUNT_BIG(*)
FROM   dbo.ColumnstoreTable
GROUP BY Symbol
...
-- Columnstore: Numeric Dictionary - Not bit packed
