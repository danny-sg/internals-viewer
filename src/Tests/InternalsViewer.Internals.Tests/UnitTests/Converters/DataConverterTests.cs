...
public class DataConverterTests
{
    ...
    [Theory]
    [InlineData("2B 01 07 20 AB 4C 1B 90 40 46 0B 00 00", "2023-12-27 17:11:33.3300000 +00:00", "datetimeoffset")]
    [InlineData("3D 01 3F 53 1B 01 E5 B0 00 00", "2023-12-27 17:11:33", "datetime")]
    [InlineData("3A 01 08 04 E5 B0", "2023-12-27 17:12:00", "smalldatetime")]
    [InlineData("28 01 40 46 0B", "2023-12-27", "date")]
    [InlineData("29 01 07 20 AB 4C 1B 90", "17:11:33.3300000", "time")]
    [InlineData("3E 01 00 00 00 00 00 D0 74 40", "333", "float")]
    [InlineData("3B 01 00 80 A6 43", "333", "real")]
    [InlineData("2A 01 07 20 AB 4C 1B 90 40 46 0B", "2023-12-27 17:11:33.3300000", "datetime2(7)")]
