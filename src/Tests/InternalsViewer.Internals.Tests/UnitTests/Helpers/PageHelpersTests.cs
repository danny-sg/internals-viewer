...
public class PageHelpersTests
{
    ...
    [InlineData(AllocationPage.FirstGamPage + AllocationPage.AllocationPageCount, true)]
    ...
    [InlineData(AllocationPage.FirstSgamPage + AllocationPage.AllocationPageCount, true)]
    ...
    [InlineData(AllocationPage.FirstDcmPage + AllocationPage.AllocationPageCount, true)]
    ...
    [InlineData(AllocationPage.FirstBcmPage + AllocationPage.AllocationPageCount, true)]
